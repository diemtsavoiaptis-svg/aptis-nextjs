  ...
  function checkAnswer() {
    if (!selectedAnswer) {
      setCheckedResults((old) => ({
        ...
        [currentIndex]: {
          type: "warning",
          message: "Please choose A, B or C before checking.",
        },
      }));
      return;
    }
    ...
    if (!correctAnswer) {
      setCheckedResults((old) => ({
        ...
        [currentIndex]: {
          type: "info",
          message:
            "Your answer has been selected. This question does not have an answer key yet.",
        },
      }));
      return;
    }
    ...
    setCheckedResults((old) => ({
      ...
      [currentIndex]: {
        ...
        message: isCorrect
          ? "Correct answer."
          : `Not correct. Correct answer: ${correctAnswer}`,
      },
    }));
  }
    ...
    return (
      <main className="part1Page">
        <section className="part1Shell">
          <div className="emptyBox">Loading Part 1 data...</div>
        </section>
      </main>
    );
  }
      ...
      <main className="part1Page">
        <section className="part1Shell">
          <div className="emptyBox">
            {mode === "student"
              ? "No Part 1 data found."
              : "No questions have been selected for guest view yet."}
          </div>
        </section>
      </main>
    );
    ...
    <main className="part1Page">
      <section className="part1Shell">
        <header className="partHeader">
          ...
          <div>
            <p>APTIS LISTENING</p>
            <h1>Part 1 Practice</h1>
            <span>
              {mode === "student"
                ? "Student Access · Full Part 1 data"
                : "Guest Access · Selected Part 1 questions"}
            </span>
          </div>
        </header>
        ...
        <section className="progressBlock">
          <div>
            <strong>
              Question {currentIndex + 1}/{rows.length}
            </strong>
            <span>{progress}%</span>
          </div>
        ...
        <section className="questionCard">
          <div className="questionTop">
            <span>Question {currentRow.stt || currentRow.order || currentIndex + 1}</span>
            <span>{mode === "student" ? "Student" : "Guest"}</span>
          </div>

          <h2>{currentRow.question || currentRow["Câu hỏi"] || "Question text"}</h2>
